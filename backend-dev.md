...
| 5 | [reuseman/flashcards-obsidian](https://github.com/reuseman/flashcards-obsidian) | 🎴 An Anki plugin for Obsidian.md | ★1,049 | anki, flashcards, markdown, obsidian, obsidian-plugin | — |
| 6 | [FooSoft/anki-connect](https://github.com/FooSoft/anki-connect) | Anki plugin to expose a remote API for creating flash cards. | ★2,058 | anki | — |
